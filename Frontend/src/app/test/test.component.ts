...
export class TestComponent implements OnInit {
  ...
  search1: OperatorFunction<string, readonly string[]> = (text$: Observable<string>) => {
    ...
    return merge(debouncedText$, inputFocus$, clicksWithClosedPopup$).pipe(
      map(term => (term === '' ? jobss
        : jobss.filter(v => v.toLowerCase().indexOf(term.toLowerCase()) > -1)).slice(0, 10))
    );
  }
  closeResult = '';
 ...
 public verticalPosition: MatSnackBarVerticalPosition = 'top';
  ...
  isLoaded = false
  constructor(config: NgbModalConfig, private modalService: NgbModal,private _snackBar: MatSnackBar,public toastr:ToastrService,public _global:GlobalService,iconRegistry: MatIconRegistry, sanitizer: DomSanitizer,private _icons:IconsService) {
  ...
  openSnackBar() {
    this._snackBar.open(this.name, 'Undo', {
      horizontalPosition: this.horizontalPosition,
      verticalPosition: this.verticalPosition,
      panelClass: "snackbar-color:primary",
  ...
  search(){
    console.log(this.mydata.jobtitle)
  ...
  showpassword(){
    //this.status=this.hide?"hide":"show";
    if(this.status=="show"){
      this.status="hide";
